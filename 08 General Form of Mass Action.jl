...
To write the differential equations of more complex systems of interactions becomes increasingly difficult as the number of species increases, and when the interactions becomes more complex, such as in systems with feedback and feedforward loops. In these situations, we can use a more automatic recipe that is based on calculations using the matrices of stochoimetric coefficients $(B-A)'$. To do this, we will use a general method based on the following equation: 
```math
\begin{align}
...
```math
Na_2CO_3 + CaCl_2 \overset{k_1}{\underset{k_2}{\longleftrightarrow}} CaCO_3 + 2 \cdot NaCl \tag{78}\\  
```
##
...
md" ## 
> __Exercise 1__: Find the order of the reactions, the units of the kinetic rate constants, write the differential equations that govern the dynamics of the following system and perform a dimensionality analysis of the following system:
>
>```math
...
# ╔═╡ 86c5267d-35ac-4314-b395-c254f87dbcc1
Foldable("Click to reveal solution of Task 1:",md"Decomposing the reversible reaction into two irreversible reactions
```math
\begin{align*}
...
md"
##
> __Task 2__: Find the order of the reactions, the units of the kinetic rate constants, write the differential equations that govern the dynamics of the following system and perform a dimensionality analysis of the following system:
>
>```math 
...
# ╔═╡ a7e7eda9-0c08-4911-af7c-4b42cae54b90
Foldable("Click to reveal solution of Task 2:",md"Decomposing the reversible reaction into two irreversible reactions
```math 
\begin{align}
...
md"
##
> __Task 3:__  Find the order of the reactions, the units of the kinetic rate constants, write the differential equations that govern the dynamics of the following system and perform a dimensionality analysis of the following system :
>
>```math 
...
# ╔═╡ f29aa357-a350-4ba7-9c97-56597643f346
Foldable("Click to reveal solution of Task 3:",md"
Decomposing the reversible reaction into two irreversible reactions
```math
\begin{align}
X_1   \overset{k_1}{\underset{}{\longrightarrow}} 2 X_2 \\
2 X_2  \overset{k_2}{\underset{}{\longrightarrow}}  X_3  
\end{align}
```
...
```math
\begin{align}
1 \cdot  X_1 + 0 \cdot X_2 + 0 \cdot X_3 \overset{k_1}{\underset{}{\longrightarrow}} 0 \cdot X_1+ 2 \cdot X_2 + 0 \cdot X_3\\
 0 \cdot X_1+ 2 \cdot X_2 + 0 \cdot X_3 \overset{k_2}{\underset{}{\longrightarrow}}  0 \cdot X_1+ 0 \cdot X_2 + 1 \cdot X_3 
\end{align}
```
...
\frac{dX_2}{dt} =   2 k_1 \cdot X_1 \cdot X_2 - 2 k_2 \cdot X_2 \tag{30}\\
...
manifest_format = "2.0"
project_hash = "ca4ffa7c8b4a135189b7ceba5d337d672d4bb5c3"
