...
begin
	...
	md"""
	##
	**Move the sliders to change the initial concentrations of reactants:** 
...
# ╔═╡ 881fbe02-8cf3-4efa-94b3-9849cba8b50b
md"""
!!! note
	##
	__Working with Functions__: A good way to write code to solve numerical models (or any other complex program) is to pack processes as separate functions that can be called with a single line of code. Modern programming languages are optimized to work with functions, resulting in much more efficient code. If you are not familiar with developing your own functions, start by following these steps:
	- First, define the function that takes two input arguments, 
	- Next, make these two input arguments as vectors. 
	- Next, perform a simple calculation inside the function
	- Next, program the function to return the result of the calculation 
	- Next, program the function to return also a string of text
	- Once this is working, take the elements of the input arguments and calculate the value of the equilibrium constant based on the equation above
	- Next, take the elements of the input arguments and calculate also the units of the equilibrium constant.
...
>##
> __Task 1:__ Write a simple computer program in your language of choice that consists of a single function that takes as input the equilibrium concentration of the reactants of the following reaction, and gives as output the $K_{eq}$ (with the correct units) of the following reaction: 
>```math
>\begin{align*}
>2 NO_2   &\overset{k_1}{\underset{k_2}{\longleftrightarrow}} N_{2}O_4 \tag{30} \\
>\end{align*}
>```
>Test the function with the following equilibrium concentrations:
>
>$[NO_2]_{eq}=2; [N_2O_4]_{eq}=3;$
>##
"

# ╔═╡ 6653f22a-1cb5-4be0-b8ca-31233c04df77
...
# ╔═╡ 58d64e49-0419-4339-b68c-29ec7891ca5f
# ╠═╡ show_logs = false
Calculate_Keq1(NO2,N2O4)

# ╔═╡ 6379c561-15e0-4913-8a90-68cccd71d201
md"
> __Task 2:__ Modify the previous function to work with the following reaction, 
>```math
>Na_{2}CO_3 + CaCl_2 \overset{k_1}{\underset{k_2}{\longleftrightarrow}} CaCO_3 + 2 \cdot NaCl \tag{31}
>```
>The function now should take as input the following arguments:
> 1. A vector containing the concentrations of the species at the left of the arrow
> 2. A vector containing the concentrations of the species at the right of the arrow
> 3. A vector containing the stoichiometric coefficients at the left of the arrow
> 4. A vector containing the stoichiometric coefficients at the right of the arrow
>
> The function should give as output the value of the $K_{eq}$ with the correct units, using the  equilibrium concentrations:
...
# ╔═╡ f31ab8c1-2326-40af-937e-0a0d18606b5d
md"

>##
> __Task 3:__ Modify the previous function to work with any chemical reaction with an arbitrary number of species.  
>
>Test your program with the following reaction: 
>```math
>\begin{align*}
>2 NO_2   &\overset{k_1}{\underset{k_2}{\longleftrightarrow}} N_{2}O_4 \tag{30} \\
>\end{align*}
...
>
>$[NO_2]_{eq}=2; [N_2O_4]_{eq}=3;$
> and also the following reaction: 
>```math
>Na_{2}CO_3 + CaCl_2 \overset{k_1}{\underset{k_2}{\longleftrightarrow}} CaCO_3 + 2 \cdot NaCl \tag{31}
>```
...
manifest_format = "2.0"
project_hash = "88f1ed7fe8aac0fafd6b46f5fc3b3d93ead24d5e"
