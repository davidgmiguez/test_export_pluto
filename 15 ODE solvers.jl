...
# ╔═╡ 9af9ec0c-3034-49df-ad15-e572e7abd0cf
md"
## 6. Conclusion
...
# ╔═╡ 21d8a46c-6a93-4a00-b2d3-5a48f86b45c8
md" ## 
> __Task 1a__: Use the ODE solver of your language of choice to solve numerically the reversible dimerization system:
>
>```math 
>a + b \overset{k_1}{\underset{k_2}{\longleftrightarrow}} c 
>```
>with rate constants $k_1=1$, and $k_2=0.01$, and with initial concentrations $X_1(0)=0.02$, $X_2(0)=0.01$ and $X_3(0)=0.0$.
>
> __Task 1b__: Introduce 10% variability in the initial conditions and run 50 simulations, calculate the average dynamics, and plot the 95% confidence interval.
"

# ╔═╡ d9f48c3a-cd45-4a6a-bddc-fc27ee125774
Foldable("Solution Task 1:", md" 
...
the transpose(B-A) is

```math
(B-A)'=\begin{bmatrix}
 -1 & 1 \\  -1 & 1  \\ 
1 & -1\end{bmatrix} ; \tag{9}
```
...
# ╔═╡ 8a3f565f-88ec-4e46-9fca-39fd479b6390
Foldable("Click to reveal plot of Task 1a:", plot(p111)) 
...
md"
##
>__Task 2:__  Solve numerically the following reversible reaction using a solver from the programming language of your preference. Adjust the simulation time to reach the equilibrium with 1% tolerance.   
> ```math
>NaCO_3 + CaCl_2  \overset{k_1}{\underset{k_2}{\longleftrightarrow}}  CaCO_3 + 2 NaCl
>```
>Use the following values $k_1=2.3e0$; $k_2=2.5e0$; $a_0=0.02$; $b_0=0.01$; $c_0=0$; $d_0=0$;"
...
begin
	...
	sol5 = solve(prob5)
	p222=plot(sol5,label=["s" "e1s" "e2p" "p"])
	title!("reversible ODE solver using DSL")
	xlabel!("Time [s]")
	ylabel!("Concentration [M]")
	nothing
...
# ╔═╡ ebf558d4-6d89-4ab0-9906-b6c1a3737265
Foldable("Click to reveal solution of Task 2",plot(p222))
...
manifest_format = "2.0"
project_hash = "497b29653273b99654e50d0520f2978ac333d89e"
